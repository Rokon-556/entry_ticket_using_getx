...
class _TicketScreenState extends State<TicketScreen> {
  ...
  void initState() {
    super.initState();
    // log("hello control:${controller.tickets.length}");
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<TicketController>(init: TicketController(),initState: (_){},builder: (controller){
                  ...
                  children: [
                        ...
                        Container(
                          child: Column(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: (){
                                  Get.to(()=>MyTicketScreen(token:controller.tickets[index].pk,ticket: controller.tickets[index],));
                    ...
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('Purchase Date:${controller.tickets[index].sellDate}'),
                          Row(
